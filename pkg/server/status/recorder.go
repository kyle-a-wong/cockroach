...
func (mr *MetricsRecorder) AddNode(
	nodeReg, appReg, logReg, sysReg, clusterMetricReg *metric.Registry,
	desc roachpb.NodeDescriptor,
	startedAt int64,
...
func (mr *MetricsRecorder) GetTimeSeriesData(childMetrics bool) []tspb.TimeSeriesData {
	...
	if childMetrics {
		...
		for tenantID, r := range mr.mu.tenantRegistries {
			...
			tenantAppRecorder.recordChangefeedChildMetrics(&data)
			...
			tenantClusterMetricRecorder.recordChangefeedChildMetrics(&data)
		}
